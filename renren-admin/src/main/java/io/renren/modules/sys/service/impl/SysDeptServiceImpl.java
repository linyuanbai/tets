...
public class SysDeptServiceImpl extends BaseServiceImpl<SysDeptDao, SysDeptEntity> implements SysDeptService {
	...
	public void save(SysDeptDTO dto) {
		// id=null, pid=1067246875800000063, name=孟津县环境监察支队, sort=2,
		// regionProvince=null, regionCity=null, regionCounty=null,
		// regionStreet=null, code=null, type=null, grade=2, nature=null,
		// isTemporary=null, validDayStart=null, validDayEnd=null,
		// status=null, address=孟津县, zipCode=466100, phone=12456897456,
		// email=456897456@qq.com, isUseable=null, master=null, deputyPerson=null,
		// remarks=null, is_deleted=null, createDate=null, parentName=洛阳市环境监察大队
	...
	public void update(SysDeptDTO dto) {
		// id=1067246875800000066, pid=0, name=河南省环境监察总队, sort=0,
		// regionProvince=null, regionCity=null, regionCounty=null, regionStreet=null,
		// code=null, type=null, grade=0, nature=null, isTemporary=null,
		// validDayStart=null, validDayEnd=null, status=null, address=河南省郑州市二七区,
		// zipCode=123456, phone=15656565656, email=4564671548@qq.com,
		// isUseable=, master=null, deputyPerson=null, remarks=null, is_deleted=null, createDate=null, parentName=一级部门
		SysDeptEntity entity = ConvertUtils.sourceToTarget(dto, SysDeptEntity.class);
